...
if($q=='semester')
{
$query = "SELECT distance_from_home.*,academic.* FROM distance_from_home,academic WHERE academic.year_of_admn = ".(date("Y", time()))." AND academic.student_id = distance_from_home.student_id ORDER BY distance_from_home.distance DESC";
$result = mysql_query($query,$con) or die(mysql_error());
...
$query = "SELECT distance_from_home.*,academic.* FROM distance_from_home,academic WHERE academic.year_of_admn = ".(date("Y", time())-1)." AND academic.student_id = distance_from_home.student_id ORDER BY distance_from_home.distance DESC";
$result = mysql_query($query,$con) or die(mysql_error());
echo '<br /><br />';
...
$query = "SELECT distance_from_home.*,academic.* FROM distance_from_home,academic WHERE academic.year_of_admn = ".(date("Y", time())-2)." AND academic.student_id = distance_from_home.student_id ORDER BY distance_from_home.distance DESC";
$result = mysql_query($query,$con) or die(mysql_error());
echo '<br /><br />';
...
$query = "SELECT distance_from_home.*,academic.* FROM distance_from_home,academic WHERE academic.year_of_admn = ".(date("Y", time())-3)." AND academic.student_id = distance_from_home.student_id ORDER BY distance_from_home.distance DESC";
$result = mysql_query($query,$con) or die(mysql_error());
echo '<br /><br />';
...
echo '<table width=100%>
<tr><th>Form No.</th><th>Academics</th><th>Name</th><th>Present Address</th><th>Distance</th><th>Category</th><th>Verified</th><th>Room No</th><th>Actions</th></tr>';
$query1 = "SELECT distance_from_home.*,student.* FROM distance_from_home,student WHERE SUBSTRING(category_code, 1 , 1)='d' AND student.student_id = distance_from_home.student_id ORDER BY distance_from_home.distance DESC";
...
echo '<table width=100%>
<tr><th>Form No.</th><th>Academics</th><th>Name</th><th>Present Address</th><th>Distance</th><th>Category</th><th>Verified</th><th>Room No</th><th>Actions</th></tr>';
$query1 = "SELECT distance_from_home.*,student.* FROM distance_from_home,student WHERE SUBSTRING(category_code, 1 , 1)='o' AND student.student_id = distance_from_home.student_id ORDER BY distance_from_home.distance DESC"; 
$result = mysql_query($query1,$con) or die(mysql_error());
while($row = mysql_fetch_array($result)){
	$id=$row['student_id'];
	$query2 = "SELECT * FROM student WHERE student_id='$id'";
...
if($q=='category')   //filter by category starts here//
{
	...
	echo '<table width=100%>
	<tr><th>Form No.</th><th>Academics</th><th>Name</th><th>Present Address</th><th>Distance</th><th>Category</th><th>Verified</th><th>Room No</th><th>Actions</th></tr>';
	$query1 = "SELECT distance_from_home.*,student.* FROM distance_from_home,student WHERE category_code='DOP' AND student.student_id = distance_from_home.student_id ORDER BY distance_from_home.distance DESC"; 
	$result = mysql_query($query1,$con) or die(mysql_error());
	while($row = mysql_fetch_array($result)){
		$id=$row['student_id'];
		$query2 = "SELECT * FROM student WHERE student_id='$id'";
	...
	echo '<table width=100%>
	<tr><th>Form No.</th><th>Academics</th><th>Name</th><th>Present Address</th><th>Distance</th><th>Category</th><th>Verified</th><th>Room No</th><th>Actions</th></tr>';
	$query1 = "SELECT distance_from_home.*,student.* FROM distance_from_home,student WHERE category_code='DOB' AND student.student_id = distance_from_home.student_id ORDER BY distance_from_home.distance DESC";
	$result = mysql_query($query1,$con) or die(mysql_error());
	while($row = mysql_fetch_array($result)){
		$id=$row['student_id'];
		$query2 = "SELECT * FROM student WHERE student_id='$id'";
	...
	echo '<table width=100%>
	<tr><th>Form No.</th><th>Academics</th><th>Name</th><th>Present Address</th><th>Distance</th><th>Category</th><th>Verified</th><th>Room No</th><th>Actions</th></tr>';
	$query1 = "SELECT distance_from_home.*,student.* FROM distance_from_home,student WHERE category_code='DSC' AND student.student_id = distance_from_home.student_id ORDER BY distance_from_home.distance DESC";
	$result = mysql_query($query1,$con) or die(mysql_error());
	while($row = mysql_fetch_array($result)){
		$id=$row['student_id'];
		$query2 = "SELECT * FROM student WHERE student_id='$id'";
	...
	echo '<table width=100%>
	<tr><th>Form No.</th><th>Academics</th><th>Name</th><th>Present Address</th><th>Distance</th><th>Category</th><th>Verified</th><th>Room No</th><th>Actions</th></tr>';
	$query1 = "SELECT distance_from_home.*,student.* FROM distance_from_home,student WHERE category_code='DST' AND student.student_id = distance_from_home.student_id ORDER BY distance_from_home.distance DESC";
	$result = mysql_query($query1,$con) or die(mysql_error());
	while($row = mysql_fetch_array($result)){
		$id=$row['student_id'];
		$query2 = "SELECT * FROM student WHERE student_id='$id'";
	...
	echo '<table width=100%>
	<tr><th>Form No.</th><th>Academics</th><th>Name</th><th>Present Address</th><th>Distance</th><th>Category</th><th>Verified</th><th>Room No</th><th>Actions</th></tr>';
	$query1 = "SELECT distance_from_home.*,student.* FROM distance_from_home,student WHERE category_code='OOP' AND student.student_id = distance_from_home.student_id ORDER BY distance_from_home.distance DESC";
	$result = mysql_query($query1,$con) or die(mysql_error());
	while($row = mysql_fetch_array($result)){
		$id=$row['student_id'];
		$query2 = "SELECT * FROM student WHERE student_id='$id'";
...
if($q=='gender')
{
	...
	echo '<table width=100%>
	<tr><th>Form No.</th><th>Academics</th><th>Name</th><th>Present Address</th><th>Distance</th><th>Category</th><th>Verified</th><th>Room No</th><th>Actions</th></tr>';
	$query1 = "SELECT distance_from_home.*,student.* FROM distance_from_home,student WHERE gender='male' AND student.student_id = distance_from_home.student_id ORDER BY distance_from_home.distance DESC";
	$result = mysql_query($query1,$con) or die(mysql_error());
	while($row = mysql_fetch_array($result)){
		$id=$row['student_id'];
		$query2 = "SELECT * FROM student WHERE student_id='$id'";
	...
	echo '<table width=100%>
	<tr><th>Form No.</th><th>Academics</th><th>Name</th><th>Present Address</th><th>Distance</th><th>Category</th><th>Verified</th><th>Room No</th><th>Actions</th></tr>';
	$query1 = "SELECT * FROM student WHERE gender='female'";
	$result = mysql_query($query1,$con) or die(mysql_error());
	while($row = mysql_fetch_array($result)){
		$id=$row['student_id'];
		$query2 = "SELECT * FROM student WHERE student_id='$id'";
...
$categ = 'OOP';
$query = "SELECT * FROM academic NATURAL JOIN distance_from_home NATURAL JOIN student WHERE academic.year_of_admn = ".(date("Y", time()))." AND academic.student_id = distance_from_home.student_id AND student.category_code = '".$categ."' ORDER BY distance_from_home.distance DESC";
$result = mysql_query($query,$con) or die(mysql_error());
...
$categ = 'OOP';
$query = "SELECT * FROM academic NATURAL JOIN distance_from_home NATURAL JOIN student WHERE academic.year_of_admn = ".(date("Y", time())-1)." AND academic.student_id = distance_from_home.student_id AND student.category_code = '".$categ."' ORDER BY distance_from_home.distance DESC";
$result = mysql_query($query,$con) or die(mysql_error());
...
$categ = 'OOP';
$query = "SELECT * FROM academic NATURAL JOIN distance_from_home NATURAL JOIN student WHERE academic.year_of_admn = ".(date("Y", time())-2)." AND academic.student_id = distance_from_home.student_id AND student.category_code = '".$categ."' ORDER BY distance_from_home.distance DESC";
$result = mysql_query($query,$con) or die(mysql_error());
...
while($row = mysql_fetch_array($result)){
 ...
 $categ = 'OOP';
$query = "SELECT * FROM academic NATURAL JOIN distance_from_home NATURAL JOIN student WHERE academic.year_of_admn = ".(date("Y", time())-3)." AND academic.student_id = distance_from_home.student_id AND student.category_code = '".$categ."' ORDER BY distance_from_home.distance DESC";
$result = mysql_query($query,$con) or die(mysql_error());
