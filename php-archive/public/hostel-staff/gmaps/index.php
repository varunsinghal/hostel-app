...
<script type="text/javascript" src="http://maps.google.com/maps?file=api&v=3&key=AIzaSyDsq3u44pvUGZVMym06AEI4awQUSr9wR6w"></script>
</head>
...
<div class="container">
  ...
  <font color="#FF3300" size="5px">DTU-HOME DISTANCE CALCULATOR</font><br /><br />
	<form action="#" name="aman" onsubmit="showLocation(); return false;">
		<p>
			Enter address : <input type="text" name="address1" />
