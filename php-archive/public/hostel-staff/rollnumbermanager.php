...
if(isset($_POST['submit']))
{
	...
	function similar_detection($id)
	{
		...
		if($simdata1['reallot']==0)
		$s='<img height="20" src="../images/fresh.png">';
		else 
		$s='<img height="20" src="../images/reallot.png">';
		$name = $simdata1['name'].'<br><br>'.$s;
